...
parser.add_argument('--norm', type=str, default='bnorm', dest='norm')  #bnorm , inorm
...
parser.add_argument('--nch_in', type=int, default=2, dest='nch_in')
# TODO
parser.add_argument('--z_slice', type=int, default=672)
parser.add_argument('--sample_result', type=str, default="./sample")
...
parser.add_argument('--nch_out', type=int, default=2, dest='nch_out')
